...
const Header = () => {
  return (
    <div className="min-h-full min-w-full flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 ">
      <div className="min-w-full flex flex-col items-center justify-center mt-6 space-x-10">
        <h1>Bem-vindo ao Escola Digital</h1>

        {/* 1º card */}
        <div className="flex flex-row items-start justify-center gap-20 mr-10">
          <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 mt-10">
            <a href="#">
              <img
                class="rounded-t-lg"
